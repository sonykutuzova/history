...
const FillInTheBlanks = ({ quest }) => {
  ...
  return (
    <div className={s.container}>
      ...
      <div className={s.questContent}>
        {/* Добавляем изображение к тексту задания, если оно есть */}
        {quest.contentImage && (
          <div className={s.contentImageContainer}>
            <img 
              src={quest.contentImage} 
              alt="Иллюстрация к заданию" 
              className={s.contentImage}
            />
            {/* {quest.contentImageCaption && (
              <p className={s.imageCaption}>{quest.contentImageCaption}</p>
            )} */}
          </div>
        )}
        ...
        {!showResults ? (
          ...
          <div className={s.results}>
            ...
            {/* Добавляем изображение к результатам, если оно есть */}
            {quest.resultImage && (
              <div className={s.resultImageContainer}>
                <img 
                  src={quest.resultImage} 
                  alt="Иллюстрация результата" 
